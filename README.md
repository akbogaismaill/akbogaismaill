...
I work on network security, penetration testing and Linux system administration. I also build blockchain projects and explore AI-driven solutions, with a strong focus on OSINT, vulnerability assessment and networking.

### Focus Areas

`Penetration Testing` · `Network Security` · `Blockchain` · `Artificial Intelligence` · `OSINT` · `Linux`
